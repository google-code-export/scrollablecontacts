...
public class ConfigurationActivity extends PreferenceActivity {
	...
	private void prepareFacebookBtn() {
		Preference pref = findPreference("FACEBOOK");
		// Bind the "onClick" for the save preferences to close the activity
		// and postback "OK"
		pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			public boolean onPreferenceClick(final Preference preference) {
				//Intent myIntent = new Intent(preference.getContext(), FBActivity.class);
                //startActivityForResult(myIntent, 0);
				startActivity(new Intent(ConfigurationActivity.this, FBActivity.class));
