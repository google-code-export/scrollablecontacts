...
public class ContactWidget extends AppWidgetProvider {
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            updateLayout(context, appWidgetId);           
        }	
	}
	
	public void updateLayout(Context context, int appWidgetId) {
        ...
        //Check if Preferences in Settings set to Black
        if (Preferences.getBGImage(context, appWidgetId) == Preferences.BG_BLACK) {
        	...
        	// else change background to white
